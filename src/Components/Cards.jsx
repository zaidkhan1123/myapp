...
<div className="col-md-4 col-sm-6 col-lg-3">
          ...
          <img className='card-img' src={"./images/heart.svg"} alt="" style={{width:"8%"}} />
            <p className="card-text">
            Honda Civic <br /> Package 1.3 2010 
            
            </p>
            <h5 className='price'>Rs 1,700,000</h5>  
            <p className='cardlocation'>Mall Road, Lahore . 1 week ago</p>
          </div>
        </div>
        ...
        <div className="col-md-4 col-sm-6 col-lg-3">
          ...
          <img className='card-img' src={"./images/heart.svg"} alt="" style={{width:"8%"}} />
            ...
            <h5 className='price'>Rs 1,800,000</h5>  
            <p className='cardlocation'>Mall Road, Lahore . 1 week ago</p>
          </div>
        </div>
        ...
        <div className="col-md-4 col-sm-6 col-lg-3">
          ...
          <img className='card-img' src={"./images/heart.svg"} alt="" style={{width:"8%"}} />
            <p className="card-text">
          I Phone 11 pro Max 64gb <br /> Package 1.3 2010 
            
            </p>
            <h5 className='price'>Rs 105,000</h5>  
            <p className='cardlocation'>Sadar, Karachi . 1 week ago</p>
          </div>
        </div>
        ...
        <div className="col-md-4 col-sm-6 col-lg-3">
          ...
          <img className='card-img' src={"./images/heart.svg"} alt="" style={{width:"8%"}} />
            <p className="card-text">
            Y20 4/64  <br /> Package 1.3 2010 
            
            </p>
            <h5 className='price'>Rs 43,000</h5>  
            <p className='cardlocation'> Baghbanpura, Lahore . 2 minutes ago</p>
          </div>
        </div>
        ...
        <div className="col-md-4 col-sm-6 col-lg-3">
                  ...
                  <img className='card-img' src={"./images/heart.svg"} alt="" style={{width:"8%"}} />
                    <p className="card-text">
                    Infinix Note 12 10/10 <br/>8/128 with   10 months warrenty 
                    
                    </p>
                    <h5 className='price'>Rs 1,700,000</h5>  
                    <p className='cardlocation'>Samanabad, Lahore. 18 hours ago</p>
                  </div>
                </div>
                ...
                <div className="col-md-4 col-sm-6 col-lg-3">
                  ...
                  <img className='card-img' src={"./images/heart.svg"} alt="" style={{width:"8%"}} />
                    ...
                    <p className='cardlocation'>Chatha Bakhtawar, Islamabad . 3 days ago</p>
                  </div>
                </div>
