...
function ProductListings(props) {
  ...
  // to pass data from ProductListings.jsx to it's parent component App.jsx
        ...
        <div className="row w-100 py-2 my-2 ">
          ...
          <div className="col-lg-8 border-bottom border-2 d-flex justify-content-between">
            <div className="CheckboxContainer">
              <input type="checkbox" className="CheckBox me-2" id="CheckBox" />
            ...
            <div className="sortBy d-flex justify-content-center align-items-center">
              ...
              <select
                id="sortBy"
                class="sortBy form-select form-select-sm border-0 fs-14 max-width"
              >
            ...
            <div className="my-3 py-3 border-bottom border-2">
              ...
              <div className="px-3">
                ...
                <ul className="list-unstyled ms-3 my-2 grayShade">
                  ...
                  <li className="fs-14 mb-1">Islamabad Capital Territory</li>
                </ul>
              </div>
            </div>
              ...
              <div className="my-3">
                <div className="CheckboxContainer mb-2">
                  <input
                    ...
                    id="usedCheckBox"
                  />
                  <label htmlFor="usedCheckBox" className="CheckBoxLable fs-14">
                    Used
                  </label>
                </div>
                <div className="CheckboxContainer mb-2">
                  <input
                    ...
                    id="newCheckBox"
                  />
                  <label htmlFor="newCheckBox" className="CheckBoxLable fs-14">
                    New
                  </label>
                </div>
                <div className="CheckboxContainer mb-2">
                  <input
                    ...
                    id="openCheckBox"
                  />
                  <label htmlFor="openCheckBox" className="CheckBoxLable fs-14">
                    Open Box
                  </label>
                </div>
                <div className="CheckboxContainer mb-2">
