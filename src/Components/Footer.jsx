...
function Footer() {
  return (
   ...
   <div className="col-md-4 col-sm-6  mt-4 ">
    ...
    <img src={"./images/f-apple.svg"} alt="" style={{width:"8rem"}} /> <img src={"./images/f-google.svg"} alt="" style={{width:"8rem"}} /> <img src={"./images/f-huawei.svg"} alt="" style={{width:"8rem"}} />  
   </div>
      </div>
  ...
  <div className="_1075545d _7ed1ca2f _96d4439a ms-5 ">
    ...
    >
      <img
        src={"./images/f-apple.svg"  } style={{width: "5rem"}}
        alt="App Store"
        className="ac2bfae3"
      />
    </a>
    ...
    >
      <img
        src={"./images/f-google.svg"  } style={{width: "5rem"}}
        alt="Google Play"
        className="ac2bfae3"
      />
    </a>
    ...
    >
      <img
         src={"./images/f-huawei.svg"  } style={{width: "5rem"}}
        alt="App Gallery"
        className="ac2bfae3"
      />
    </a>
 ...
 <div className="row last-rwo  text-end">
  <div className="col-md-12">
  <div class="b49f6016"><div class="_035521cc"><div class="_8bdcd3a2"><span>Free Classifieds in Pakistan</span> . © 2006-2022 OLX</div></div></div>
  </div>
 </div>
