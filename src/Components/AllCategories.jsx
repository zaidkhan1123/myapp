      ...
      <div className="category-items border-end border-bottom border-start mx-4 container bg-white">
                        <div className="row">
                            <div className="category-item col-lg-3 mt-5 lh-base">
                                ...
                                <ul type='none'>
                                    <li className='fw-bold mt-5 mb-3'> <a href='/'>	Vehicles	</a></li>
                                    <li> <a href='/'>	Cars	</a></li>
                            ...
                            <div className="category-item col-lg-3 lh-base">
                                ...
                                <ul type='none'>
                                    <li className='fw-bold mt-5 mb-3'> <a href='/'>	Services	</a></li>
                            ...
                            <div className="category-item col-lg-3 lh-base">
                                ...
                                <ul type='none'>
                                    <li className='fw-bold mt-5 mb-3'> <a href='/'>	Books, Sports & Hobbies	</a></li>
                                ...
                                <ul type='none'>
                                    <li className='fw-bold mt-5 mb-3'> <a href='/'>	Kids	</a></li>
                                    <li> <a href='/'>	Toys	</a></li>
