      ...
      <div className="category-items border-end border-bottom border-start mx-4 container bg-white">
                        <div className="row">
                            <div className="category-item col-lg-3 mt-5 lh-base">
                                <ul type='none' >
                                    <li className='fw-light mb-3 '> <a href='/' className='sub-heading'> Mobiles  </a>   </li>
                                ...
                                <ul type='none'>
                                    <li className='fw-light mt-5 mb-3'> <a href='/' className='sub-heading'>	Vehicles	</a></li>
                                    <li> <a href='/'>	Cars	</a></li>
                                ...
                                <ul type='none'>
                                    <li className='fw-light mt-5 mb-3 '> <a href='/' className='sub-heading'>	Property for Sale	</a></li>
                                ...
                                <ul type='none'>
                                    <li className='fw-light mt-5 mb-3 '> <a href='/' className='sub-heading'>	Property for Rent	</a></li>
                                    <li> <a href='/'>	Houses	</a></li>
                                    <li> <a href='/'>	Portions & Floors	</a></li>
                                    <li> <a href='/'>	Apartments & Flats	</a></li>
                                    <li> <a href='/'>	Shops - Offices - Commercial Space	</a></li>
                            ...
                            <div className="category-item col-lg-3 lh-base">
                                <ul type='none'>
                                    <li className='fw-light mt-5 mb-3 '> <a href='/' className='sub-heading'>	Electronics & Home Appliances	</a></li>
                                ...
                                <ul type='none'>
                                    <li className='fw-light mt-5 mb-3 '> <a href='/'className='sub-heading'>	Bikes	</a></li>
                                ...
                                <ul type='none'>
                                    <li className='fw-light mt-5 mb-3 '> <a href='/' className='sub-heading'>	Business, Industrial & Agriculture	</a></li>
                                ...
                                <ul type='none'>
                                    <li className='fw-light mt-5 mb-3'> <a href='/'className='sub-heading' >	Services	</a></li>
                            ...
                            <div className="category-item col-lg-3 lh-base">
                                <ul type='none'>
                                    <li className='fw-light mt-5 mb-3 '> <a href='/' className='sub-heading'>	Jobs	</a></li>
                                    ...
                                    <li> <a href='/'>	Delivery Riders	</a></li>
                                    <li> <a href='/'>	Internships	</a></li>
                                    <li> <a href='/'>	Architecture & Interior Design	</a></li>
                                </ul>

                                <ul type='none'>
                                    <li className='fw-light mt-5 mb-3 '> <a href='/' className='sub-heading'>	Animals	</a></li>
                            ...
                            <div className="category-item col-lg-3 lh-base">
                                <ul type='none'>
                                    <li className='fw-light mt-5 mb-3 '> <a href='/' className='sub-heading'>	Furniture & Home Decor	</a></li>
                                ...
                                <ul type='none'>
                                    <li className='fw-light mt-5 mb-3 '> <a href='/' className='sub-heading'>	Fashion & Beauty	</a></li>
                                ...
                                <ul type='none'>
                                    <li className='fw-light mt-5 mb-3'> <a href='/' className='sub-heading'>	Books, Sports & Hobbies	</a></li>
                                ...
                                <ul type='none'>
                                    <li className='fw-light mt-5 mb-3'> <a href='/' className='sub-heading'>	Kids	</a></li>
                                    <li> <a href='/'>	Toys	</a></li>
